...
<body>
	<header class="clearfix">
		<div class="container">
			...
			<div class="company-address">
				<h2 class="title"><img src="../invoice/lawma.png" width="120px" height="50px"/></h2>
				<p>
			...
			<div class="company-contact">
				<left><img src="../invoice/logo.png"/></left>
				...
				<div class="email right">
					...
					<a href="mailto:info@gafista.com">info@gafista.com</a>
					<span class="helper"></span>
		...
		<div class="container">
			<div class="details clearfix">
				<div class="client left">
					<h3>INVOICE TO:</h3>
					<h3 class="title"><?php echo $customerName; ?></h3>
					
                </div>
                <div class="data right">
					<div class="title">Transaction-ID: <?php echo $txn_ref; ?></div>
				</div>  
            </div>
				...
				<table class="grand-total">
					<tbody>
						...
						<tr>
							<td class="desc"></td>
							<td class="qty"></td>
							<td class="unit">Transaction Fee:</td>
    ...
    <!-- REQUIRED HIDDEN FIELDS -->
                ...
                <input class="btn btn-success" type="submit" value="Make Payment"></input>
                <input class="btn btn-default" type="button" onclick="print_current_page()" value="Print Invoice"></input>
            </form> 

			<div class="end"> This Invoice was created from <img src="../invoice/logo.png" width="50px height="40px"> WebApp and is valid without the signature and seal.</div>
		</div>
    </footer>
